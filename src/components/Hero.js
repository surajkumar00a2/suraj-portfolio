            ...
            <div className="space-y-4">
              <ScrollReveal delay={0.1}>
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight">
                  <span className="text-text">{profile.name.split(' ')[0]} </span>
            ...
            <ScrollReveal delay={0.5}>
              <div className="flex flex-wrap gap-4">
                ...
                <motion.a
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-lg glass glow-border text-text font-semibold"
                >
                ...
                <motion.a
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-lg glass glow-border-accent text-text font-semibold"
                >
